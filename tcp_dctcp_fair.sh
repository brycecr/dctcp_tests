...
for qsize in 200; do
    ...
    mkdir $dirf
    rm -rf $dir1
    python tcpfair.py --cong dctcp --cong1 dctcp --congrest reno --delay $delay -b $bwnet -B $bwhost -d $dir1 --maxq $qsize -t $time \
    ...
    python plot_queue.py -f $dir1/q.txt --legend "tcp-w/ecn"  -o \
